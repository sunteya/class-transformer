...
var TransformOperationExecutor = /** @class */ (function () {
    ...
    TransformOperationExecutor.prototype.transform = function (source, value, targetType, arrayType, isMap, level) {
        ...
        if (Array.isArray(value) || value instanceof Set) {
            ...
            var _loop_1 = function (key) {
                ...
                var valueKey = key;
                var newValueKey = this_1.options.propertyFormat ? this_1.options.propertyFormat(key) : key, propertyName = this_1.options.propertyFormat ? this_1.options.propertyFormat(key) : key;
                ...
                if (!this_1.options.enableCircularCheck || !this_1.isCircular(subValue)) {
                    ...
                    if (this_1.transformationType === TransformationType.CLASS_TO_PLAIN) {
                        ...
                        finalValue = this_1.applyCustomTransformations(finalValue, targetType, transformKey, value, valueKey, this_1.transformationType);
                    ...
                    finalValue = this_1.applyCustomTransformations(finalValue, targetType, key, value, valueKey, this_1.transformationType);
                    if (finalValue !== undefined || this_1.options.exposeUnsetFields) {
                        if (newValue instanceof Map) {
                            newValue.set(newValueKey, finalValue);
                        }
    ...
    TransformOperationExecutor.prototype.applyCustomTransformations = function (value, target, key, obj, valueKey, transformationType) {
        var _this = this;
        ...
        metadatas.forEach(function (metadata) {
            value = metadata.transformFn({ value: value, key: key, obj: obj, type: transformationType, valueKey: valueKey, options: _this.options });
        });
        return value;
    };
